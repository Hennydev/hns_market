...
const PaymentMethod = ({setSelectMethod}) => {
  ...
  return (
    ...
    <div>   <button onClick={()=>setSelectMethod(true)} className="bg-[#009B30] text-sm py-1.5 px-2 rounded-lg text-white my-2">Save</button> </div>
    </div >
  )
}
