...
const SelectCard = ({setToggleNewCard}) => {
  return (
  ...
  <div>     <button className="bg-[#009B30] text-sm py-1.5 px-2 rounded-lg text-white my-2">Continue to Payment</button> </div>
  </div >
  )
}
