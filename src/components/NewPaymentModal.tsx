...
function NewPaymentModal({ paymentModal, setPaymentModal }) {

    // const [paymentModal, setPaymentModal] = useState(false);
    return (

            
                <div className="bg-white border md:mx-0 mx-3 rounded-xl">
                    ...
                    <div className="py-3 mx-5 ">
                        ...
                        <div className="bg-white border  rounded-lg">
                            ...
                            <div className="flex flex-col text-center items-center mx-auto justify-center md:w-[40%]">
                    ...
                    <div className="pb-4 mt-2 text-[#009B30] mx-5 text-md flex items-center">
